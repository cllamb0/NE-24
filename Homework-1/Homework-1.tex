...
\begin{center}
\textsf{\underline{Answer:} cd \~{} \textit{or}  cd ..  \textit{or}  cd}
\end{center}
...
\begin{center}
\textsf{\underline{Answer:} ls -r -F /Users/backup}
\end{center}
...
\begin{center}
\textsf{\underline{Answer:} When –s is used with ls, it shows the sizes of the files in blocks and when –h is used with ls, it does nothing different than a normal ls.}
\end{center}
\end{enumerate}
...
\end{flushleft}
\begin{center}
\textsf{\underline{Answer:} When given multiple filenames, it will copy and move those multiple files into the chosen directory.}
\end{center}

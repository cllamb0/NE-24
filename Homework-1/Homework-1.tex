...
\begin{center}
\texttt{\underline{Answer:} ../backup: No such file or directory}
\end{center}
...
\begin{center}
\texttt{\underline{Answer:} cd \~{} \textit{or}  cd ..  \textit{or}  cd}
\end{center}
...
\begin{center}
\texttt{\underline{Answer:} ls -r -F /Users/backup}
\end{center}

%Question 4, Section 1
\item What does the command \emph{cd} without a directory name do?
\begin{center}
\texttt{\underline{Answer:} It changes the working directory to the user's home directory.}
\end{center}

%Question 5, Section 1
\item What does the command \emph{ls} do when used with the \emph{-s} and \emph{-h} arguments?
\begin{center}
\texttt{\underline{Answer:} When –s is used with ls, it shows the sizes of the files in blocks and when –h is used with ls, it does nothing different than a normal ls.}
\end{center}
\end{enumerate}
\vskip.4in
